...
/**
 * Represents a point in terms of x and y co-ordinates.
 * 
 * @author Debadarsini
 *
 */
public class Point implements Comparable<Point> {
    ...
    private void validateInput(Point point) {
        if (point.x < 0 || point.x > 32767 || point.y < 0 || point.y > 32767)
            throw new IllegalArgumentException("points should be in integer limit");
    }
}
